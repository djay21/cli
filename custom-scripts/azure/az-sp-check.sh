...
do
echo -e "\n****** starting function password and certificate check for  *** $(az ad sp list --all  --query '[].{ID:appId,NAME:displayName}' -o table | grep 00edd498-7c0c-4e68-859c-5a55d518c9c0 | awk '{$1=""}1' ) -- $app_id ****"
password_check
certificate_check
done